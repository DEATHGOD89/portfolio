          ...
          <div className="grid lg:grid-cols-2 gap-12">
            ...
            <div>
              <div className="flex items-center mb-8">
                <GraduationCap className="w-8 h-8 text-crimson-400 mr-3" />
                  ...
                  <div key={index} className="glass-card p-6 rounded-xl hover-lift">
                    <div className="flex items-start justify-between mb-4">
                      <div className="flex-1">
                        ...
                        <p className="text-crimson-400 font-medium mb-1">
                          {edu.institution}
                        </p>
            ...
            <div>
              <div className="flex items-center mb-8">
                <Award className="w-8 h-8 text-crimson-400 mr-3" />
                  ...
                  <div key={index} className="glass-card p-4 rounded-xl hover-lift">
                    <div className="flex items-start justify-between">
                      <div className="flex-1">
                        ...
                        <p className="text-crimson-400 text-sm mb-1">{cert.issuer}</p>
                        {cert.description && (
                      ...
                      <div className="text-right">
                        ...
                        <div className="mt-1">
                          <span className="px-2 py-1 bg-crimson-400/10 text-crimson-400 text-xs rounded-full border border-crimson-400/20">
                            {cert.type}
                          </span>
                        </div>
                      </div>
              ...
              <div className="flex items-center mb-6">
                <Award className="w-6 h-6 text-crimson-400 mr-2" />
                ...
                {achievements.map((achievement, index) => (
                  <div key={index} className="glass-card p-4 rounded-xl hover-lift">
                    <div className="flex items-start justify-between mb-2">
                      ...
                      <span className="text-crimson-400 text-sm">{achievement.year}</span>
                    </div>
