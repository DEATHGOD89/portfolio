    ...
    <section id="contact" className="py-24 relative bg-gray-900 dark:bg-gray-900 light:bg-gray-50 overflow-hidden">
      ...
      <div className="absolute inset-0 opacity-5">
        {[...Array(20)].map((_, i) => (
          <div
            key={i}
            className="absolute bg-crimson-400 animate-float"
            style={{
      ...
      <div className="container mx-auto px-6">
        <div className="max-w-6xl mx-auto">
          ...
          <div className="text-center mb-16 animate-fadeInUp">
            ...
            <div className="w-24 h-1 bg-gradient-to-r from-crimson-400 to-crimson-600 mx-auto mb-8"></div>
          ...
          <div className="grid lg:grid-cols-2 gap-12">
            ...
            <div className="animate-fadeInLeft">
              <div className="flex items-center mb-8">
                <div className="w-8 h-8 bg-crimson-400 rounded-lg flex items-center justify-center mr-3 animate-pulse">
              ...
              <div className="space-y-4 mb-8">
                ...
                <div className="glass-card p-6 rounded-xl hover-lift animate-fadeInUp hover:rotate-1 transition-all duration-500" style={{ animationDelay: '0.2s' }}>
                  <div className="flex items-center">
                    <div className="w-12 h-12 bg-crimson-400 rounded-lg flex items-center justify-center mr-4 animate-pulse hover:scale-110 transition-transform duration-300">
                      <Mail className="w-6 h-6 text-black" />
                    </div>
                    <div>
                      <h4 className="text-white dark:text-white light:text-gray-900 font-semibold mb-1">Email</h4>
                      <p className="text-crimson-400 font-medium">bhupendersingh123456789011@gmail.com</p>
                ...
                <div className="glass-card p-6 rounded-xl hover-lift animate-fadeInUp hover:rotate-1 transition-all duration-500" style={{ animationDelay: '0.4s' }}>
                  <div className="flex items-center">
                    ...
                    <div>
                      ...
                      <p className="text-crimson-400 font-medium">+91-8295205166</p>
                ...
                <div className="glass-card p-6 rounded-xl hover-lift animate-fadeInUp hover:rotate-1 transition-all duration-500" style={{ animationDelay: '0.6s' }}>
                  <div className="flex items-center">
                    ...
                    <div>
                      ...
                      <p className="text-crimson-400 font-medium">Rohtak, Haryana, India</p>
              ...
              <form onSubmit={handleSubmit} className="space-y-6">
                ...
                <div>
                  ...
                  <textarea
                    ...
                    required
                    rows={6}
                    className="w-full px-4 py-3 bg-gray-800/50 dark:bg-gray-800/50 light:bg-white border border-gray-700 dark:border-gray-700 light:border-gray-300 rounded-lg text-white dark:text-white light:text-gray-900 placeholder-gray-400 dark:placeholder-gray-400 light:placeholder-gray-500 focus:outline-none focus:border-crimson-400 focus:scale-105 transition-all duration-300 resize-none"
                  />
                </div>
