    ...
    <section className="py-24 relative overflow-hidden">
      ...
      <div className="absolute inset-0 opacity-5">
        {[...Array(20)].map((_, i) => (
          <div
            key={i}
            className={`absolute ${darkMode ? 'bg-crimson-400' : 'bg-black'} animate-float`}
            style={{
                ...
                <div className="relative h-48 overflow-hidden">
                  ...
                  <div className="absolute bottom-4 right-4">
                    <div className="p-2 bg-black/50 backdrop-blur-sm rounded-lg">
                      <article.icon className="w-5 h-5 text-crimson-400" />
                    </div>
                  </div>
                </div>

                <div className="p-6">
                  <h3 className="text-xl font-bold text-white mb-3 group-hover:text-crimson-400 transition-colors duration-300 line-clamp-2">
                    {article.title}
                  </h3>
                  ...
                  <button className="inline-flex items-center text-crimson-400 hover:text-crimson-300 font-medium transition-colors duration-300 group-hover:translate-x-2 transform">
                    Read More
