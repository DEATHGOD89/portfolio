            ...
            {testimonials.map((testimonial, index) => (
              ...
              >
                ...
                <div className="flex justify-center mb-6">
                  <div className="p-3 bg-crimson-400 rounded-full group-hover:scale-110 transition-transform duration-300">
                ...
                <div className="flex justify-center mb-4">
                  {[...Array(testimonial.rating)].map((_, i) => (
                    <Star key={i} className="w-5 h-5 text-crimson-400 fill-current animate-pulse" style={{ animationDelay: `${i * 0.1}s` }} />
                  ))}
                </div>
                ...
                <div className="flex items-center justify-center">
                  ...
                  <div className="text-center">
                    ...
                    <p className="text-crimson-400 text-sm">{testimonial.role}</p>
